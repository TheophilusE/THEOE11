...
void STAR::Setup()
{
    ...
    engineParameters_[EP_RESOURCE_PATHS] = "C:\\THEO\\Projects\\STAR;C:\\THEO\\Projects\\STAR\\CoreData;C:"
                                           "\\THEO\\Projects\\STAR\\Resources;C:\\THEO\\Projects\\STAR\\Cache";
...
void STAR::RegisterObjects(Context* context)
{
    ...
    // loaded / saved
    Urho3D::Character::RegisterObject(context);
...
void STAR::CreateScene()
{
    ...
    // load scene
    XMLFile* xmlLevel = cache->GetResource<XMLFile>("Scenes/MainMenu.xml");
...
void STAR::CreateCharacter()
{
    ...
    character_ = objectNode->CreateComponent<Urho3D::Character>();
