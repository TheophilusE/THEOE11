...
State::State(Context* context)
    : Object(context)
{
    eastl::string directory = GetSubsystem<FileSystem>()->GetUserDocumentsDir() + DOCUMENTS_DIR;
...
void State::SetValue(const eastl::string& name, const Variant& value, bool save)
{
...
const Variant& State::GetValue(const eastl::string& name) { return data_[name]; }
