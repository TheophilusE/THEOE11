...
public:
    ...
    void LogIn(const eastl::string& email, const eastl::string& password);
    void Register(const eastl::string& email, const eastl::string& password, const eastl::string& username);
    void CreateMatch();
    void JoinMatch(const eastl::string& matchID);
    void LeaveMatch();
    void SendChatMessage(const eastl::string& message);
