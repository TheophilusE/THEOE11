...
void NakamaManager::Init()
{
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_login", ConsoleCommandAdd::P_EVENT,
              "#nakama_login", ConsoleCommandAdd::P_DESCRIPTION, "Log with the nakama server",
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_command", ConsoleCommandAdd::P_EVENT,
              "#nakama_command", ConsoleCommandAdd::P_DESCRIPTION, "nakama_command", ConsoleCommandAdd::P_OVERWRITE,
              true);
    SubscribeToEvent("#nakama_command",
                     [&](StringHash eventType, VariantMap& eventData)
                     {
                         ...
                         client_->rpc(
                             session_, command.CString(), payload.CString(),
                             [&](const NRpc& nRpc)
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_read", ConsoleCommandAdd::P_EVENT,
              "#nakama_read", ConsoleCommandAdd::P_DESCRIPTION, "Read user data from nakama",
              ConsoleCommandAdd::P_OVERWRITE, true);
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_create_match", ConsoleCommandAdd::P_EVENT,
              "#nakama_create_match", ConsoleCommandAdd::P_DESCRIPTION, "Create a match",
              ConsoleCommandAdd::P_OVERWRITE, true);
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_join_match", ConsoleCommandAdd::P_EVENT,
              "#nakama_join_match", ConsoleCommandAdd::P_DESCRIPTION, "Join a match", ConsoleCommandAdd::P_OVERWRITE,
              true);
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_matchmaker", ConsoleCommandAdd::P_EVENT,
              "#nakama_matchmaker", ConsoleCommandAdd::P_DESCRIPTION, "Create matchmaker",
              ConsoleCommandAdd::P_OVERWRITE, true);
    SubscribeToEvent("#nakama_matchmaker",
                     [&](StringHash eventType, VariantMap& eventData)
                     {
                         ...
                         rtClient_->addMatchmaker(minCount, maxCount, query, stringProperties, numericProperties,
                                                  successCallback);
                     });

    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_send_match_data", ConsoleCommandAdd::P_EVENT,
              "#nakama_send_match_data", ConsoleCommandAdd::P_DESCRIPTION, "Send match data",
              ConsoleCommandAdd::P_OVERWRITE, true);
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_send_message", ConsoleCommandAdd::P_EVENT,
              "#nakama_send_message", ConsoleCommandAdd::P_DESCRIPTION, "Send chat message",
              ConsoleCommandAdd::P_OVERWRITE, true);
    ...
    SendEvent(E_CONSOLE_COMMAND_ADD, ConsoleCommandAdd::P_NAME, "nakama_leave_match", ConsoleCommandAdd::P_EVENT,
              "#nakama_leave_match", ConsoleCommandAdd::P_DESCRIPTION, "Leave match", ConsoleCommandAdd::P_OVERWRITE,
              true);
...
void NakamaManager::LogIn(const String& email, const String& password)
{
    ...
    client_->authenticateEmail(email.CString(), password.CString(), "", true, {}, loginSucceededCallback,
                               loginFailedCallback);
}
...
void NakamaManager::Register(const String& email, const String& password, const String& username)
{
    ...
    client_->authenticateEmail(email.CString(), password.CString(), username.CString(), true, {},
...
void NakamaManager::JoinMatch(const String& matchID)
{
    ...
    rtClient_->joinMatch(matchID.CString(), {},
                         [&](const NMatch& match)
                         {
                             ...
                             for (auto& presence : match.presences)
                             {
                                 ...
                                 {
                                     URHO3D_LOGINFOF("User id=%s username=%s", presence.userId.c_str(),
                                                     presence.username.c_str());
                                 }
                             }
                         });
}
