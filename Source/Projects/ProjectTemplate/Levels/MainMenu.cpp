...
void MainMenu::AddButton(const eastl::string& buttonName, const eastl::string& label, const eastl::string& windowToOpen,
...
Button* MainMenu::CreateButton(const eastl::string& text)
{
