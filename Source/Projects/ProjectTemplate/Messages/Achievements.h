...
public:
     ...
     */
    eastl::list<AchievementRule> GetAchievements();
...
private:
    ...
    void AddAchievement(eastl::string message, eastl::string eventName, eastl::string image, int threshold,
                        eastl::string parameterName = "", Variant parameterValue = Variant::EMPTY);
     ...
     */
    eastl::list<SharedPtr<SingleAchievement>> activeAchievements_;

    /**
     * Only 1 achievement is allowed at a time,
     * so all additional achievements are added to the queue
     */
    eastl::list<VariantMap> achievementQueue_;
     ...
     */
    eastl::hash_map<StringHash, eastl::list<AchievementRule>> registeredAchievements_;

    /**
     * All achievements
     */
    eastl::list<AchievementRule> achievements_;

    /**
     * Current achievement progress
     */
    eastl::hash_map<eastl::string, int> progress_;
};
