...
void ModLoader::LoadASMods()
{
    ...
    GetSubsystem<FileSystem>()->ScanDir(result, GetSubsystem<FileSystem>()->GetProgramDir() + String("Data/Mods"),
                                        String("*.as"), SCAN_FILES, false);
...
void ModLoader::LoadLuaMods()
{
    ...
    // Scan Data/Mods directory for all *.as files
    GetSubsystem<FileSystem>()->ScanDir(luaMods_, GetSubsystem<FileSystem>()->GetProgramDir() + String("Data/Mods"),
                                        String("*.lua"), SCAN_FILES, false);
    ...
    SubscribeToEvent("#mod_test",
                     [&](StringHash eventType, VariantMap& eventData)
                     {
                         ...
                         if (params.Size() >= 2)
                         {
                             ...
                             //            Resource* res =
                             //            GetSubsystem<ResourceCache>()->GetResource<Resource>(filename);
                         }
