...
public:
    ...
    void SetOptionName(const eastl::string& name);
    eastl::string GetOptionName() const { return option_name_; }

    UIElement* GetControl() const { return control_; }

protected:
    eastl::string option_name_;
...
public:
    ...
    void SetOptionLabel(bool state, const eastl::string& text);
    eastl::string GetOptionLabel(bool state) const;
...
public:
    ...
    eastl::string GetValue() const;

private:
    int options_count_;
    eastl::vector<eastl::string> strings_;
    int index_;
...
public:
    ...
    ListView* AddTab(const eastl::string& name);
    void RemoveTab(const eastl::string& name);
