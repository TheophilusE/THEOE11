...
Button* AchievementsWindow::CreateItem(const eastl::string& image, const eastl::string& message, bool completed,
                                       int progress, int threshold)
{
    CreateSingleLine();
    CreateSingleLine();
    ...
    toolTipText->SetText("Progress: " + eastl::to_string(progress) + " / " + eastl::to_string(threshold));
