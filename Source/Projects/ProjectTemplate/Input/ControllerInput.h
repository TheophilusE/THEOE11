...
public:
     ...
     */
    eastl::vector<int> GetControlIndexes();

    /**
     * Get mapping against all controls
     */
    eastl::hash_map<int, eastl::string> GetControlNames();

    /**
     * Retrieve key name for specific action
     */
    eastl::string GetActionKeyName(int action);
     ...
     */
    void SetConfiguredKey(int action, int key, eastl::string controller);
...
private:
     ...
     */
    eastl::hash_map<int, eastl::string> controlMapNames_;

    /**
     * Active controls
     */
    eastl::hash_map<int, Controls> controls_;

    /**
     * All input handlers
     */
    eastl::hash_map<int, SharedPtr<BaseInput>> inputHandlers_;
